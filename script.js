...
addBtn.addEventListener('click', function () {
  const noteHeading = document.querySelector('#note-heading').value;
  ...
  if(textNote === "") {
    ...
    noteArea.setAttribute('class', 'added-note-area');
    noteArea.setAttribute('id', `${id}`);
    noteArea.innerHTML = `
      
      <nav class="note-nav-bar">
        <div>
    ...
    showNotes.appendChild(noteArea);
    notes.push(noteHeading);
  }
